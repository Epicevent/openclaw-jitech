...
export const uk: TranslationMap = {
  ...
  usage: {
    ...
    providerLedger: {
      title: "Provider call receipts",
      subtitle:
        "Immutable, content-free receipts from actual provider calls. Missing usage stays unavailable instead of becoming zero.",
      source: "Receipt ledger truth",
      calls: "Provider calls",
      inputNonCached: "Non-cached input",
      cacheRead: "Cache read",
      cacheWrite: "Cache write",
      output: "Output candidates",
      thinking: "Reasoning / thinking",
      toolUse: "Tool-use prompt",
      cost: "Provider cost",
      costUnavailable: "Unavailable (no pricing evidence)",
      knownSubtotal: "Known subtotal {value} ({known}/{total} receipts)",
      unavailableDimension: "Unavailable ({known}/{total} receipts)",
      unavailable: "The immutable provider receipt ledger could not be read.",
      actualModels: "Actual response models",
      actualModelMissing: "actual model unavailable",
      coverageLabel: "Producer coverage",
      highWatermark: "Ledger high-watermark",
      legacyNotice:
        "Conversation transcript analytics below; not provider receipts or billing truth.",
      coverage: {
        complete: "complete",
        partial: "частково",
