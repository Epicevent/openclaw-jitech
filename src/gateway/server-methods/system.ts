...
export const systemHandlers: GatewayRequestHandlers = {
  ...
  // Customer builds contain curated user-provided patch notes without internal source
  // metadata; detailed development builds add private source links. Runtime slots do not
  // mutate this product-release record.
